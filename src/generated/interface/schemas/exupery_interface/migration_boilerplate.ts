...
export namespace _T_Imports {
    ...
    export type RESULT = _i_out._T_Imports
}
...
export namespace _T_Module {
    ...
    export type RESULT = _i_out._T_Module
}
...
export namespace _T_Module_Set {
    ...
    export type RESULT = _i_out._T_Module_Set
}
...
export namespace _T_Type_Arguments {
    ...
    export type RESULT = _i_out._T_Type_Arguments
}
...
export namespace _T_Type_Parameter_Selection {
    ...
    export type RESULT = _i_out._T_Type_Parameter_Selection
}
...
export namespace _T_Type_Parameters {
    ...
    export type RESULT = _i_out._T_Type_Parameters
}
