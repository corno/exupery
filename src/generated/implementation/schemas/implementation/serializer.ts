...
import * as _i_r_interface from "../interface/serializer"
import * as _i_signatures from "../../../interface/schemas/implementation/serializer"
                                ...
                                switch ($[0]) {
                                    ...
                                    case 'transform': return _pa.ss($, ($) => ({
                                        ...
                                        'value': ['verbose group', _pa.dictionary_literal({
                                            ...
                                            'resulting node': _pa.cc($['resulting node'], ($) => ['optional', $.transform(
                                                ($): _i_out._T_Value.SG.optional => ['set', _i_r_interface.Type(
                                                    $,
                                                    {
                                                        'value serializers': $p['value serializers'],
