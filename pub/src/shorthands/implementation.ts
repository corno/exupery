...
export namespace s {
    ...
    export const call = (
        ...
        'start': _p.wrap_state_group(['call', {
            'source': source,
            'context': context,
            'arguments': arguments_ === undefined ? _p.optional.not_set() : _p.optional.set(_p.wrap_dictionary(arguments_)),
        }]),
        'tail': _p.wrap_list(tail),
    })
...
export namespace i {
    ...
    export const argument_selection = (
        argument: string,
        tail: _p.Raw_Or_Normal_List<unresolved.Selection.tail.L<_pi.Deprecated_Source_Location>>
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['selection', {
    ...
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['array', _p.wrap_list(elements)]) }])

    export const array_map = (
        source: unresolved.Selection<_pi.Deprecated_Source_Location>,
        expression: unresolved.Initialization<_pi.Deprecated_Source_Location>
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['transformation', {
        'source': source,
    ...
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', {
    ...
    export const change_context = (
        ...
        expression: unresolved.Initialization<_pi.Deprecated_Source_Location>
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['change context', {
    ...
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['group', _p.wrap_dictionary(properties)]) }])

    export const implement_me = (): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['selection', {
        'start': _p.wrap_state_group(['implement me', null]),
        'tail': _p.wrap_list([])
    }])
    ...
    export const integer = (
        ...
        'value': _p.wrap_state_group<unresolved.Literal.SG<_pi.Deprecated_Source_Location>>(['number', _p.wrap_state_group<unresolved.Literal.SG._number.SG<_pi.Deprecated_Source_Location>>(['integer', value])])
    }])

    export const not_set = (): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['optional', _p.wrap_state_group(['not set', null])]) }])

    export const null_ = (): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['null', null]) }])
    ...
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['selection', selection])
    ...
    export const set = (
        value: unresolved.Initialization<_pi.Deprecated_Source_Location>
    ): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['optional', _p.wrap_state_group(['set', value])]) }])
    ...
    export const true_ = (): unresolved.Initialization<_pi.Deprecated_Source_Location> => _p.wrap_state_group(['literal', { 'value': _p.wrap_state_group(['boolean', _p.wrap_state_group(['true', null])]) }])
