...
export namespace g {
    ...
    export const nested_block = (snippets: _psh.Raw_Or_Normal_List<d_target.Block.L>): d_target.Group_Part => ['nested block', _psh.wrap_list(snippets)]

    export const sub = (group_parts: _psh.Raw_Or_Normal_List<d_target.Group.L>): d_target.Group_Part => ['sub group', _psh.wrap_list(group_parts)]
...
export namespace b {
    ...
    export const indent = (blocks: _psh.Raw_Or_Normal_List<d_target.Group.L>): d_target.Block_Part => ['indent', _psh.wrap_list(blocks)]

    export const snippet = (snippet: string): d_target.Block_Part => ['snippet', snippet]

    export const sub = (Block_Parts: _psh.Raw_Or_Normal_List<d_target.Block.L>): d_target.Block_Part => ['sub block', _psh.wrap_list(Block_Parts)]
...
export const group = (Group_Parts: _psh.Raw_Or_Normal_List<d_target.Group.L>): d_target.Group => _psh.wrap_list(Group_Parts)
...
export namespace t {
    ...
    export const function_ = (
        ...
        parameters: _psh.Raw_Or_Normal_List<d_target.Type.SG._function.parameters.L>,
    ...
    export const tuple = (
        read_only: 'readonly' | '', 
        elements: _psh.Raw_Or_Normal_List<d_target.Type>): d_target.Type => {
        return ['tuple', {
            'readonly': read_only === 'readonly',
            'elements': _psh.wrap_list(elements)
        }]
    }
    export const type_literal = (properties: _psh.Raw_Or_Normal_Dictionary<d_target.Type.SG.type_literal.properties.D>): d_target.Type => {
        return ['type literal', {
    ...
    export const type_reference = (
        ...
        type_arguments: _psh.Raw_Or_Normal_List<d_target.Type>,
    ): d_target.Type => {
    ...
    export const union = (cases: _psh.Raw_Or_Normal_List<d_target.Type>): d_target.Type => {
...
export namespace e {
    ...
    export const object_literal = (properties: _psh.Raw_Or_Normal_Dictionary<d_target.Expression.SG.object_literal.properties.D>): d_target.Expression => {
        return ['object literal', {
            'properties': _psh.wrap_dictionary(properties),
        }]
    }
    export const list_literal = (
        elements: _psh.Raw_Or_Normal_List<d_target.Expression>
    ): d_target.Expression => {
